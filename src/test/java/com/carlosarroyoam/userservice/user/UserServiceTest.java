...
class UserServiceTest {
  ...
  @InjectMock private RoleRepository roleRepository;
  ...
  void shouldThrowExceptionWhenFindUserWithNonExistingUsername() {
    ...
    Throwable ex =
        assertThrows(NotFoundException.class, () -> userService.findByUsername("carroyom"));
  ...
  void shouldThrowExceptionWhenUpdateWithNonExistingUser() {
    ...
    Throwable ex =
        assertThrows(NotFoundException.class, () -> userService.update(1L, updateUserRequestDto));
